...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, BMI088_ACCEL__SPI_CS_Pin|BMI088_ACCEL__SPI_CSC3_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : BMI088_ACCEL__SPI_CS_Pin BMI088_ACCEL__SPI_CSC3_Pin */
  GPIO_InitStruct.Pin = BMI088_ACCEL__SPI_CS_Pin|BMI088_ACCEL__SPI_CSC3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
